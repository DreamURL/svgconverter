...
function generateInlineSVG(svgContent, config, svgEditorState, animationConfig) {
    ...
    if (animationConfig && animationConfig.type && animationConfig.direction) {
        ...
        animationDuration: '${animationConfig.duration}s' !important,
        animationIterationCount: ${animationConfig.iterationCount === 'infinite' ? "'infinite'" : animationConfig.iterationCount} !important,
        animationTimingFunction: '${animationConfig.timingFunction}' !important,
        animationDelay: '${animationConfig.delay}s' !important,`;
...
.${className} {
  animation: ${config.animation} 2s infinite;
        ...
        return `${animationConfig ? `/* Import required CSS */
...
function AnimationPanel({ onAnimationChange, isDarkMode, initialConfig }) {
    ...
    const [duration, setDuration] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0.4);
...
//# sourceMappingURL=src_71ed6eae._.js.map